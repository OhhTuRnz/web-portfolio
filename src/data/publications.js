...
function mergePublications(scraped, overrides) {
  return scraped.map((pub, idx) => {
    ...
    return {
      ...
      doi:         clean.doi         || pub.doi       || ax.doi        || eprintAbs || pub.scholar_url,
      pdfUrl:      clean.pdfUrl      || pub.pdf_url   || ax.pdf_url    || eprintPdf || null,
      abstract:    clean.abstract    || pub.abstract  || ax.abstract   || '',
